...
p <- plot_padoh(table1,time_cat = T) +
...
ggpubr::annotate_figure(p, bottom =  ggpubr::text_grob("*Adult lymphohematopoietic cancer: Non-Hodgkin lymphoma, myeloma, and lymphocytic leukemia\n**All childhood cancer: Diagnosed before 20 years of age with leukemia, brain tumors, lymphomas, Wilms tumor, bone and soft tissue cancer, and other pediatric cancers", 
                                          size = 10))
